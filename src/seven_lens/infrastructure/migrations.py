    ...
    with psycopg.connect(dsn, autocommit=True) as connection, connection.cursor() as cursor:
        ...
        cursor.execute(
            ...
            SELECT to_regclass('public.schema_metadata'),
                   ...
                   to_regclass('public.order_intents'),
                   ...
                   to_regclass('public.account_baseline_revisions'),
               to_regclass('public.source_objects'),
               to_regclass('public.source_records'),
               to_regclass('public.evidence_packets'),
               to_regclass('public.analysis_runs'),
               to_regclass('public.analysis_stage_results'),
               to_regclass('public.research_bundles'),
               to_regclass('public.research_bundle_items'),
               to_regclass('public.risk_rejection_feedback'),
               to_regclass('public.proposal_contexts'),
               to_regclass('public.proposal_runs'),
               to_regclass('public.risk_debates'),
               to_regclass('public.portfolio_proposals'),
               to_regclass('public.proposal_stage_results'),
               to_regclass('public.model_call_claims'),
               to_regclass('public.model_call_audits'),
               to_regclass('public.reflection_records'),
               to_regclass('public.reflection_sources'),
               to_regclass('public.reflection_corrections'),
               to_regclass('public.memory_artifacts'),
               to_regclass('public.memory_artifact_sources'),
